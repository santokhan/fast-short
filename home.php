...
<div class="mx-auto w-full max-w-screen-xl px-4 py-12">
    <h1 class="text-3xl font-bold text-center flex items-center justify-center">Find jobs on FastShort<?php include './src/scroll-button.php'; ?></h1>

    <?php include './includes/job_cards.php'; ?>

    <div class="flex justify-center itmes-center mt-8" id="scrollToBottom">
