        ...
        <>
            ...
            <main className='min-h-screen'>
                <section className='max-w-2xl px-4 mx-auto'>
                    ...
                    <p className='mb-4'>
                        These terms and conditions govern your use of the 1x Short website and services. By accessing
                        this website, we assume you accept these terms and conditions. Do not continue to use 1x Short
                    ...
                    <p className='mb-4'>
                        Other than the content you own, under these terms, 1x Short and/or its licensors own all the
                    ...
                    <p className='mb-4'>
                        This website is provided "as is," with all faults, and 1x Short makes no express or implied
                    ...
                    <p className='mb-4'>
                        In no event shall 1x Short, nor any of its officers, directors, and employees, be held liable
                        for anything arising out of or in any way connected with your use of this website, whether such
                        liability is under contract. 1x Short, including its officers, directors, and employees shall
                        not be held liable for any indirect, consequential, or special liability arising out of or in
                        any way related to your use of this website.
                    </p>

                    <h2 className='text-xl font-semibold mb-2'>6. Severability</h2>
                    <p className='mb-4'>
                    ...
                    <h2 className='text-xl font-semibold mb-2'>7. Variation of Terms</h2>
                    <p className='mb-4'>
                        1x Short is permitted to revise these terms at any time as it sees fit, and by using this
                        website you are expected to review these terms on a regular basis.
                    </p>

                    <h2 className='text-xl font-semibold mb-2'>8. Entire Agreement</h2>
                    <p className='mb-4'>
                        These terms constitute the entire agreement between 1x Short and you in relation to your use of
                        this website and supersede all prior agreements and understandings.
                    </p>

                    <h2 className='text-xl font-semibold mb-2'>9. Governing Law & Jurisdiction</h2>
                    <p className='mb-4'>
                        These terms will be governed by and construed in accordance with the laws of [Your Country], and
