...
$job_posts = [
    [
        "id" => "1",
        "title" => "Senior Software Engineer at TechXcellence Corp.",
        "src" => "/assets/images/software-engineer.webp",
        "location" => "Austin, TX",
        "description" => "TechXcellence Corp. is seeking a Senior Software Engineer to design and develop scalable software solutions. You will collaborate with cross-functional teams to architect and implement features that meet customer needs.",
        "requirements" => "Bachelor's degree in Computer Science or related field. Extensive experience with backend development using languages such as Java, Python, or C#. Strong understanding of software engineering principles and design patterns. Experience with cloud platforms like AWS or Azure.",
        "publish_date" => "10 May 2024",
        "tags" => ['ui', 'job', 'freelance', 'outsource', 'web', 'backend'],
        "author" => [
            "name" => "Burhan Uddin",
            "email" => "1xshort.com@gmail.com",
        ]
    ],
    [
        "id" => "2",
        "title" => "UX/UI Designer at CreativeMinds Agency",
        "src" => "/assets/images/ux-ui.webp",
        "location" => "Los Angeles, CA",
        "description" => "CreativeMinds Agency is looking for a talented UX/UI Designer to create engaging and intuitive user experiences. You will collaborate with product managers and developers to design wireframes, prototypes, and visual designs.",
        "requirements" => "Bachelor's degree in Design, HCI, or related field. Proficiency in design tools such as Sketch, Adobe XD, or Figma. Strong understanding of user-centered design principles and usability testing methodologies.",
        "publish_date" => "18 April 2024",
        "tags" => ['ui', 'job', 'freelance', 'outsource', 'web', 'design'],
        "author" => [
            "name" => "Burhan Uddin",
            "email" => "1xshort.com@gmail.com",
        ]
    ...
    [
        ...
        "publish_date" => "13 Feb 2024",
        "tags" => ['ui', 'job', 'freelance', 'outsource', 'web', 'devops'],
        "author" => [
            "name" => "Burhan Uddin",
            "email" => "1xshort.com@gmail.com",
        ]
    ...
    [
        ...
        "src" => "/assets/images/tech-solutions.webp",
        "location" => "Chicago, IL",
        ...
        "tags" => ['ui', 'job', 'freelance', 'outsource', 'web', 'product-management'],
        "author" => [
            "name" => "Burhan Uddin",
            "email" => "1xshort.com@gmail.com",
        ]
    ...
    [
        ...
        "src" => "/assets/images/cyber-security.webp",
        ...
        "publish_date" => "10 May 2024",
        "tags" => ['ui', 'job', 'freelance', 'outsource', 'web', 'cybersecurity'],
        "author" => [
            "name" => "Burhan Uddin",
            "email" => "1xshort.com@gmail.com",
        ]
    ...
    [
        ...
        "publish_date" => "16 March 2024",
        "tags" => ['ui', 'job', 'freelance', 'outsource', 'web', 'full-stack'],
        "author" => [
            "name" => "Burhan Uddin",
            "email" => "1xshort.com@gmail.com",
        ]
    ...
    [
        ...
        "publish_date" => "10 May 2024",
        "tags" => ['ui', 'job', 'freelance', 'outsource', 'web', 'mobile'],
        "author" => [
            "name" => "Burhan Uddin",
            "email" => "1xshort.com@gmail.com",
        ]
    ...
    [
        ...
        "tags" => ['ui', 'job', 'freelance', 'outsource', 'web', 'hardware', 'software'],
        "author" => [
            "name" => "Burhan Uddin",
            "email" => "1xshort.com@gmail.com",
        ]
    ...
    [
        "id" => "11",
        "title" => "Frontend Developer at WebTech Innovations",
        "src" => "/assets/images/react.webp",
        "location" => "San Francisco, CA",
        "description" => "WebTech Innovations is looking for a skilled Frontend Developer to join our team. You will be responsible for implementing visual elements that users see and interact within a web application, ensuring high performance and responsiveness.",
        "requirements" => "Bachelor's degree in Computer Science or related field. Proficiency in HTML, CSS, and JavaScript. Experience with frontend frameworks such as React or Vue.js. Familiarity with RESTful APIs and version control systems (e.g., Git).",
        "publish_date" => "2 Feb 2024",
        "tags" => ['ui', 'job', 'freelance', 'outsource', 'web', 'frontend', 'react'],
        "author" => [
            "name" => "Burhan Uddin",
            "email" => "1xshort.com@gmail.com",
        ]
    ...
    [
        ...
        "src" => "/assets/images/monster-affiliate.webp",
        "location" => "New York City, NY",
        "description" => "BrightIdeas Co. is seeking a dynamic Marketing Manager to develop and execute marketing strategies to drive brand awareness and lead generation. Responsibilities include creating content, managing social media channels, and analyzing campaign performance.",
        "requirements" => "Bachelor's degree in Marketing, Communications, or related field. Proven experience in digital marketing, including SEO, SEM, and email marketing. Strong analytical and project management skills.",
        "publish_date" => "2 Jan 2024",
        "tags" => ['ui', 'job', 'freelance', 'outsource', 'web', 'marketing', 'digital'],
        "author" => [
            "name" => "Burhan Uddin",
            "email" => "1xshort.com@gmail.com",
        ]
