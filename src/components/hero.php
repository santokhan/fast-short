<div class="min-h-[calc(100svh_-_4rem)] flex items-center justify-center bg-cover bg-no-repeat bg-bottom" style="background-image: url(/assets/images/bg-hero.jpg);">
    <div class="max-w-screen-xl mx-auto px-4 text-center">
        ...
        <div class="flex justify-center">
            <input type="text" placeholder="Search jobs..." class="w-full md:w-1/2 px-4 py-3 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            <button class="ml-2 px-6 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">Search</button>
        </div>
    </div>
</div>