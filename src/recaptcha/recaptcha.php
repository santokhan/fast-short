...
<form id="myForm">
    <div class="flex flex-col justify-center items-center">
        <button class="g-recaptcha <?php echo $styleButton; ?>" data-sitekey="6LcWE_gpAAAAAFIpkGc7Dg3S7A5Jcgl_gSiwXwHd" data-callback='onSubmit' data-action='submit'>Submit</button>
    </div>
</form>
